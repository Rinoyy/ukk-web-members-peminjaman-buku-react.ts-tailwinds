...
import { BookOpen, BookMarked, AlertTriangle, PenLine, FileText, Package, Hash, Inbox, ChevronLeft } from 'lucide-react';
...
const BookDetail = () => {
    ...
    const { user } = useAuth();
    const { book, eligibility, loading, error, fetchBook, fetchEligibility } = useBookDetail();
